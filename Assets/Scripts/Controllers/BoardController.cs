    ...
    void GenerateBySideWinder()
    {
        ...
        for (int y = 0; y < _boardSize; y++)
        {
            for (int x = 0; x < _boardSize; x++)
            {
                ...
                if (x % 2 == 0 || y % 2 == 0)
                    ...
                    tile.tileType = Tile.TileType.Empty;
                _tile[y, x] = tile;
            }
        }
        ...
        for (int y = 0; y < _boardSize; y++)
        {
            ...
            for (int x = 0; x < _boardSize; x++)
            {
                ...
                if (y == _boardSize - 2)
                {
                    _tile[y, x + 1].tileType = Tile.TileType.Empty;
                    continue;
                }
                if (x == _boardSize - 2)
                {
                    _tile[y + 1, x].tileType = Tile.TileType.Empty;
                    continue;
                }
                ...
                else
                {
                    ...
                    _tile[y + 1, x - randomindex * 2].tileType = Tile.TileType.Empty;
                    count = 1;
                }
            }
        }
        _tile[0, 1].tileType = Tile.TileType.Start;
        _tile[_boardSize - 2, _boardSize - 2].tileType = Tile.TileType.End;
    }
